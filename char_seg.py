...
CROPPED_IMAGES_PATH = 'C:/Users/Gunjan/Desktop/Custom_haar_cascade/TRAINING_DATA/indian car number plate/*'
TARGET_WIDTH = 28
TARGET_HEIGHT = 35
...
def read_images(pathname):
    """
    Read the images to a list given a path
